      ...
      <AtlasKitThemeProvider mode="light">
        <div className="deep-linking-desktop">
          <div className="header">
            {HIDE_DEEP_LINKING_LOGO ? null : <img className="logo" src="images/logo-deep-linking.png" />}
          </div>
            ...
            <div className="rightColumn" style={rightColumnStyle}>
              <div className="rightColumnContent">
                ...
                <p className="description">
                  {t(`${_TNS}.${isSupportedBrowser() ? 'description' : 'descriptionWithoutWeb'}`, {
                    app: NATIVE_APP_NAME,
                  })}
                </p>
                <div className="buttons">
                  <ButtonGroup>
                    ...
                    {isSupportedBrowser() && (
                      <Button onClick={this._onLaunchWeb}>{t(`${_TNS}.launchWebButton`)}</Button>
                    )}
                  </ButtonGroup>
                </div>
              </div>

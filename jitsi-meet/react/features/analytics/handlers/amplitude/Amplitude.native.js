...
class Amplitude {
   ...
   * @returns {void}
   */
  setUserId(userId, opt_userId, opt_config, opt_callback) {
    // eslint-disable-line camelcase, no-unused-vars
  ...
  logEvent(eventType, eventProperties) {
    ...
    AmplitudeNative.logEvent(this._instanceName, eventType, JSON.stringify(eventProperties));
  }
}
  ...
  getInstance(options = {}) {
    ...
    if (internalInstanceName === '') {
      ...
      instance = instances[internalInstanceName] =
        instances[internalInstanceName] || new Amplitude(internalInstanceName);
    }

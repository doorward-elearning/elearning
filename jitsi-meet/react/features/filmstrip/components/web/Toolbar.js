...
import { AudioMuteButton, HangupButton, VideoMuteButton } from '../../../toolbox/components';
  ...
  render() {
    return (
      <div className="filmstrip-toolbox" id="new-toolbox">
        <HangupButton tooltipPosition="left" visible={this._shouldShowButton('hangup')} />
        <AudioMuteButton tooltipPosition="left" visible={this._shouldShowButton('microphone')} />
        <VideoMuteButton tooltipPosition="left" visible={this._shouldShowButton('camera')} />
        <SettingsButton tooltipPosition="left" visible={this._shouldShowButton('fodeviceselection')} />
      </div>
    );
  }

...
export default class OverlayFrame extends Component<Props, State> {
  ...
  constructor(props: Props) {
    ...
    this.state = {
       ...
       * @type {boolean}
       */
      filmstripOnly: typeof interfaceConfig !== 'undefined' && interfaceConfig.filmStripOnly,
    };
  }
   ...
   */
  render() {
    let containerClass = this.props.isLightOverlay ? 'overlay__container-light' : 'overlay__container';
    ...
    return (
      <div className={containerClass} id="overlay">

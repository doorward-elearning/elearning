    ...
    return (
      <FilmstripOnlyOverlayFrame isLightOverlay={true}>
        <div className="inlay-filmstrip-only__container">
          <div className="inlay-filmstrip-only__title">{t('suspendedoverlay.title')}</div>
          <div className="inlay-filmstrip-only__text">{translateToHTML(t, 'suspendedoverlay.text')}</div>
        </div>

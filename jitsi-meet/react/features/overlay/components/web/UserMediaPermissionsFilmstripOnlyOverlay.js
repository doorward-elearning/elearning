 ...
 */
class UserMediaPermissionsFilmstripOnlyOverlay extends AbstractUserMediaPermissionsOverlay {
  /**
  ...
  render() {
    ...
    return (
      <FilmstripOnlyOverlayFrame icon="icon-mic-camera-combined" isLightOverlay={true}>
        <div className="inlay-filmstrip-only__container">
          ...
          <div className="inlay-filmstrip-only__text">{translateToHTML(t, textKey)}</div>
        </div>

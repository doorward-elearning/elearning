...
import { AVATAR_ID_COMMAND, AVATAR_URL_COMMAND, EMAIL_COMMAND, JITSI_CONFERENCE_URL_KEY } from './constants';
import {
...
function _addConferenceListeners(conference, dispatch) {
  ...
  conference.on(JitsiConferenceEvents.TRACK_MUTE_CHANGED, (_, participantThatMutedUs) => {
  ...
  conference.on(JitsiConferenceEvents.PARTICIPANT_CONN_STATUS_CHANGED, (...args) =>
  ...
  conference.addCommandListener(AVATAR_ID_COMMAND, (data, id) =>
    dispatch(
      participantUpdated({
        conference,
        id,

...
class ConfirmDialog extends BaseSubmitDialog<Props, *> {
  ...
  _renderAdditionalButtons() {
    ...
    return (
      <TouchableOpacity
        ...
        style={[_dialogStyles.button, brandedDialog.buttonFarLeft, _dialogStyles.buttonSeparator]}
      >
  ...
  _renderSubmittable() {
    ...
    const content =
      typeof contentKey === 'string' ? t(contentKey) : this._renderHTML(t(contentKey.key, contentKey.params));

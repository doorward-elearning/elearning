...
class Toolbox extends Component<Props, State> {
  ...
  render() {
    ...
    return (
      <div className={rootClassNames} id="new-toolbox" onMouseOut={this._onMouseOut} onMouseOver={this._onMouseOver}>
  ...
  _onShortcutToggleRaiseHand() {
    sendAnalytics(
      createShortcutEvent('toggle.raise.hand', ACTION_SHORTCUT_TRIGGERED, { enable: !this.props._raisedHand })
    );
  ...
  _onToolbarToggleScreenshare() {
    ...
    sendAnalytics(
      createShortcutEvent('toggle.screen.sharing', ACTION_SHORTCUT_TRIGGERED, { enable: !this.props._screensharing })
    );
  ...
  _renderOverflowMenuContent() {
    ...
    return [
      ...
      this._shouldShowButton('videoquality') && (
        <OverflowMenuVideoQualityItem key="videoquality" onClick={this._onToolbarOpenVideoQuality} />
      ),
      this._shouldShowButton('fullscreen') && (
        <OverflowMenuItem
      ...
      />,
      <SettingsButton key="settings" showLabel={true} visible={this._shouldShowButton('settings')} />,
      <MuteEveryoneButton key="mute-everyone" showLabel={true} visible={this._shouldShowButton('mute-everyone')} />,
  ...
  _renderToolboxContent() {
    ...
    if (buttonsLeft.length > maxNumberOfButtonsPerGroup) {
      movedButtons.push(
        ...buttonsLeft.splice(maxNumberOfButtonsPerGroup, buttonsLeft.length - maxNumberOfButtonsPerGroup)
      );
      ...
      <div className="toolbox-content">
        ...
        <div className="button-group-right">
          {buttonsRight.indexOf('localrecording') !== -1 && (
            <LocalRecordingButton onClick={this._onToolbarOpenLocalRecordingInfoDialog} />
          )}
...
function _mapStateToProps(state) {
  ...
  if (enableFeaturesBasedOnToken) {
    ...
    desktopSharingEnabled =
      getParticipants(state).find(({ features = {} }) => String(features['screen-sharing']) === 'true') !== undefined;

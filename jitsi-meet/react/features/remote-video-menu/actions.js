...
import { AUDIO_MUTE, createRemoteMuteConfirmedEvent, createToolbarEvent, sendAnalytics } from '../analytics';
...
export function muteLocal(enable: boolean) {
  return (dispatch: Dispatch<any>) => {
    ...
    typeof APP === 'undefined' || APP.UI.emitEvent(UIEvents.AUDIO_MUTED, enable, true);
  };
}

...
export default class AbstractStreamKeyForm<P: Props> extends Component<P, State> {
  ...
  constructor(props: P) {
    ...
    this.helpURL =
      (typeof interfaceConfig !== 'undefined' && interfaceConfig.LIVE_STREAMING_HELP_LINK) || LIVE_STREAMING_HELP_LINK;

    this._debouncedUpdateValidationErrorVisibility = debounce(this._updateValidationErrorVisibility.bind(this), 800, {
      leading: false,
    });

...
export default class DeviceSelectionPopup {
  ...
  _onSubmit(newSettings) {
    ...
    if (newSettings.selectedVideoInputId !== this._dialogProps.selectedVideoInputId) {
      promises.push(this._setVideoInputDevice(newSettings.selectedVideoInputId));
    }

    if (newSettings.selectedAudioInputId !== this._dialogProps.selectedAudioInputId) {
      promises.push(this._setAudioInputDevice(newSettings.selectedAudioInputId));
    }

    if (newSettings.selectedAudioOutputId !== this._dialogProps.selectedAudioOutputId) {
      promises.push(this._setAudioOutputDevice(newSettings.selectedAudioOutputId));
    }
  ...
  _updateAvailableDevices() {
    this._getAvailableDevices().then((devices) => this._changeDialogProps({ availableDevices: devices }));
  }
}

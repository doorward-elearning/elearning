  ...
  render() {
    ...
    return (
      ...
      >
        ...
        {showDialog && (
          <JoinByPhoneDialog joinConferenceWithoutAudio={joinConferenceWithoutAudio} onClose={_closeDialog} />
        )}
      </PreMeetingScreen>
    );
  }
...
function mapStateToProps(state, ownProps): Object {
  ...
  const showConferenceInfo =
    typeof isInviteButtonEnabled === 'undefined' || isInviteButtonEnabled === true ? showJoinActions : false;

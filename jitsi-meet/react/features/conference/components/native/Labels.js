    ...
    return (
      <View pointerEvents="box-none" style={styles.labelWrapper}>
        <View
          ...
          style={[styles.indicatorContainer, wide && _filmstripVisible && styles.indicatorContainerWide]}
        >
          <TouchableOpacity
          ...
          <TouchableOpacity
            onLayout={this._createOnLayout(LABEL_ID_TRANSCRIBING)}
            onPress={this._createOnPress(LABEL_ID_TRANSCRIBING)}
          >
            {this._renderTranscribingLabel()}
          </TouchableOpacity>
          <TouchableOpacity
            onLayout={this._createOnLayout(LABEL_ID_INSECURE_ROOM_NAME)}
            onPress={this._createOnPress(LABEL_ID_INSECURE_ROOM_NAME)}
          >
            {this._renderInsecureRoomNameLabel()}
          </TouchableOpacity>
          <TouchableOpacity
            onLayout={this._createOnLayout(LABEL_ID_QUALITY)}
            onPress={this._createOnPress(LABEL_ID_QUALITY)}
          >
            {this._renderVideoQualityLabel()}
          </TouchableOpacity>
        </View>
        <View style={[styles.indicatorContainer, wide && _filmstripVisible && styles.indicatorContainerWide]}>

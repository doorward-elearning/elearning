...
export const validateConferenceModule = async req => {
  ...
  req
    .checkBody('title')
    .notEmpty()
    .withMessage('Conference title is required')
    .custom(() => !module)
...
export const validateModuleExists = async req => {
  ...
  if (!module) {
    return [404, undefined, 'Conference module does not exist or has been deleted.'];
  }
};

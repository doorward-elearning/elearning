      ...
      <div className="container">
        <div className="row mb-5 justify-content-center">
          <div className="col-lg-7 text-center" data-aos="fade-up" data-aos-delay="">
            ...
            <p>
              Don't buy the Courses. Create them yourself
            </p>
          </div>
        </div>
        <div className="row mb-5 align-items-center">
          ...
          <div className="col-lg-4 mr-auto order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
            <h4 className="text-black mb-4"> We allow your teachers to create Self-Paced Courses, and enroll students to it <br /><br />Teachers can Easily Create Contents such as Videos, HTML Tutorials, Assignments, Assessments, Quiz, Books <br /><br /> We support all Indian Native Languages and Special Characters (Eg: Roman)</h4>
          </div>
        </div>
      </div>
    </div>

...
<html lang="en">
  <head>
    <title>Edudoor &mdash; Enlighten Learners </title>
    <meta charset="utf-8">
    ...
    <header class="site-navbar py-4 js-sticky-header site-navbar-target" role="banner">
      ...
      <div class="container-fluid">
        <div class="d-flex align-items-center">
          <div class="site-logo mr-auto w-25"><a href="index.html">Edudoor</a></div>
            ...
            <div class="col-12">
              <div class="row align-items-center">
                <div class="col-lg-6 mb-4">
                  ...
                  <p class="mb-4"  data-aos="fade-up" data-aos-delay="200">Edudoor is a platform for teachers to create and run courses, Instantly collaborate with students, Collect feedbacks, share course materials, Conduct and track assessment, live virtual classroom, and many more features that makes learning engaging..</p>
                ...
                <div class="col-lg-5 ml-auto" data-aos="fade-up" data-aos-delay="500">
                  <form action="" method="post" class="form-box">
                    ...
                    <div class="form-group">
                      <input type="submit" class="btn btn-primary btn-pill" value="Try Edudoor">
                    </div>
                  </form>
                </div>
              </div>
      ...
      <div class="container">
        ...
        <div class="row justify-content-center">
          <div class="col-md-7">
            ...
            <p class="mb-5">Address: 126A, Parayil, Anappara PO, Angamaly - 683581 <br> Phone: +91-8197408582 <br> Email: info@edudoor.org <br> <br> Alternatively you can fill and submit the below form and we will get back to you. </p>

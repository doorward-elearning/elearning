...
export class CreateConversationAndMessage1609594054878 implements MigrationInterface {
    name = 'CreateConversationAndMessage1609594054878'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "ChatMessages_status_enum" AS ENUM('0', '1', '2', '3', '4')`);
        await queryRunner.query(`CREATE TABLE "ChatMessages" ("id" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "text" character varying NOT NULL, "status" "ChatMessages_status_enum" NOT NULL DEFAULT '0', "conversationId" character varying, "senderId" character varying, CONSTRAINT "REL_4a68f02e80dd448a69ee7458b0" UNIQUE ("senderId"), CONSTRAINT "PK_55cbfe04f86a557414495c8b273" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "ChatMessages" ADD CONSTRAINT "FK_7a27218c621e959b6ba6d64ed2e" FOREIGN KEY ("conversationId") REFERENCES "Conversations"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "ChatMessages" ADD CONSTRAINT "FK_4a68f02e80dd448a69ee7458b09" FOREIGN KEY ("senderId") REFERENCES "Users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);

...
export class CreateConversationAndMessage1609595123143 implements MigrationInterface {
    name = 'CreateConversationAndMessage1609595123143'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "ChatMessages_status_enum" AS ENUM('0', '1', '2', '3', '4')`);
        await queryRunner.query(`CREATE TABLE "ChatMessages" ("id" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "text" character varying NOT NULL, "status" "ChatMessages_status_enum" NOT NULL DEFAULT '0', "conversationId" character varying, "senderId" character varying, CONSTRAINT "PK_55cbfe04f86a557414495c8b273" PRIMARY KEY ("id"))`);

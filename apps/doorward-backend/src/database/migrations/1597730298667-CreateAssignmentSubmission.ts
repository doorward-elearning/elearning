...
export class CreateAssignmentSubmission1597730298667 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "AssignmentSubmissions" ("id" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "type" "AssignmentSubmissions_type_enum" NOT NULL, "submission" text NOT NULL, "points" integer NOT NULL DEFAULT 0, "status" "AssignmentSubmissions_resubmission_enum" NOT NULL DEFAULT 'Draft', "numResubmissions" integer NOT NULL DEFAULT 0, "gradedOn" TIMESTAMP, "resubmittedOn" TIMESTAMP, "grade" integer NOT NULL DEFAULT 0, "organizationId" character varying, "studentId" character varying, "assignmentId" character varying, "graderId" character varying, CONSTRAINT "PK_505d4c3a6e848eb7298fdf787b8" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(

...
export class InitializeDatabase1596896845962 implements MigrationInterface {
    name = 'InitializeDatabase1596896845962'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "fullName" character varying NOT NULL, "avatar" character varying, "role" "users_role_enum" NOT NULL DEFAULT 'PUBLISHER', "data" character varying, "screen_token" character varying NOT NULL, "webcam_token" character varying NOT NULL, "raising_hand" boolean NOT NULL DEFAULT true, "meetingId" uuid, CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "whiteboards" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "state" text, "active" boolean NOT NULL, "createdById" uuid, "meetingId" uuid, CONSTRAINT "REL_6a928e497bc596e031cc3284d4" UNIQUE ("createdById"), CONSTRAINT "PK_c9b7a16e551b6190f23ad5741a2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "meetings" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "sessionId" character varying NOT NULL, "darkThemeLogo" character varying, "logo" character varying, CONSTRAINT "PK_aa73be861afa77eb4ed31f3ed57" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "FK_97cf4b5e1027545e209a527d6d3" FOREIGN KEY ("meetingId") REFERENCES "meetings"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);

...
export class MainLayout {
   ...
   * @hidden
   */
  private opts: MainLayoutOptions;

  /**
   * Update the layout container
   */
  updateLayout(timeout?: number) {
    setTimeout(() => {
   ...
   * @param opts
   */
  initLayoutContainer(container: HTMLElement, opts: MainLayoutOptions = LayoutOptions) {
    this.opts = {
   ...
   * @param options
   */
  setLayoutOptions(options: MainLayoutOptions) {
    this.opts = options;
  }

...
@Component({
  ...
  template: `
    <div [hidden]="showColorPicker" class="canvas-whiteboard-colorpicker-input" (click)="toggleColorPicker($event)">
    ...
    <div [hidden]="!showColorPicker" class="canvas-whiteboard-colorpicker-wrapper">
      ...
      <canvas
        ...
        class="canvas-whiteboard-colorpicker"
        width="284"
        height="155"
        (click)="selectColor(determineColorFromCanvas($event))"
      ></canvas>
    </div>
  `,
  styles: [
